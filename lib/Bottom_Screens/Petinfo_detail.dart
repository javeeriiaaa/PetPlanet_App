...
class PetInfoDetailPage extends StatefulWidget {
  final Cat cat;
  const PetInfoDetailPage({Key? key, required this.cat}) : super(key: key);

  @override
  State<PetInfoDetailPage> createState() => _PetInfoDetailPageState();
}

class _PetInfoDetailPageState extends State<PetInfoDetailPage> {
  @override
